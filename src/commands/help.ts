  ...
  execute: commandWrapper(async (interaction) => {
    const embed = new EmbedBuilder()
      ...
      .addFields([
        ...
        { name: '/pupper', value: 'Replies with a random pupper!' },
        { name: '/registerguild', value: 'Registers the guild with the bot.' },
        { name: '/unregisterguild', value: 'Unregisters the guild with the bot.' },
        { name: '/updateguild', value: 'Updates the guild with the bot.' },
      ]);
